    ...
    return (
        <div>
            ...
            <main>
                ...
                {/* Porfolio Cursor  */}
                <div className="cursor large" id="portf_cursor_6">View <br />Project</div>
                {/* Header area start  */}
                ...
                <header className="header__area-2">
                    <div className="header__inner-5">
                        ...
                        <div className="header__nav-icon-5">
                            <button id="open_offcanvas"><span className="menu-text-pp">Menu</span><img src="assets/imgs/icon/menu-black.png"

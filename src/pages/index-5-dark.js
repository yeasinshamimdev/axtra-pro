                    ...
                    <div id="smooth-content">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xxl-4 col-xl-4 col-lg-5 col-md-5">
                                                    <div class="cta__btn-5">
                                                        <a class="btn-together" href="contact.html">Let’s work together <span><i
                        ...
                        <footer class="footer__area-5">
                            <div class="container">
                                <div class="row">
                                    <div class="col-xxl-12">
                                        <a href="index.html" class="logo-dark"><img src="assets/imgs/icon/5/footer-logo-5-2.png"
                                            alt="Site Logo" /></a>
                                        <a href="index.html" class="logo-light"><img src="assets/imgs/icon/5/footer-logo-5.png"
                                            alt="Site Logo" /></a>

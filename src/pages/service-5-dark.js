                ...
                <div id="smooth-wrapper">
                    <div id="smooth-content">
                        <main>
                            ...
                            <section className="portfolio__service service-v5 pt-140 pb-140 blog__animation">
                                <div className="container">
                                    <div className="row">
                                        <div className="col-xxl-5 col-xl-5 col-lg-6 col-md-6">
                                            <h2 className="sec-title animation__char_come"> I MAKE
                                                THE Service
                                                BETTER.</h2>
                                        </div>
                                ...
                                <div className="container line pt-140 pb-100">
                                    ...
                                    <div className="row">
                                        <div className="col-xxl-12">
                                            <h2 className="brand__title-3 title-anim">We are happy to work with global largest brands</h2>
